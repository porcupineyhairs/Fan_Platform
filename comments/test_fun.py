...
#     interface_name = '/announce/addComplexAnnounce'
#     test_case_info = CaseInit('announce_api.yml', interface_name)
...
#
#         try:
#             response = RequestTool().requestTool(case_step['method'], case_step['url'], case_step['requests'],
...
#             Assertions().assert_key_value(response_data, case_step['response'])
#             Assertions().assert_jsonpath(response_data, case_step['response'], case_step['jsonpath'])
#
#             # 提取需要从结果中保存的字段
